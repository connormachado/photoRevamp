...
5. When verifier PASSes (or after 3 failed attempts), STOP and print:
   "Phase ready for your check. Run `make start`, look at [specific thing], then
   reply 'continue' or describe what's wrong."
